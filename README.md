...
|------|------------------|
| BANK_FINANCE_PROJECT.ipynb | ML model to predict loan default |
| ML_AI_Banking risk.ipynb | Automated risk grading per Basel III |
| banking_call_prediction.ipynb | Predict customer response to tele‑marketing |
| SQL_attrition_project.sql | Identify drivers of employee attrition |
| Sql_fianace_analysis project.sql | Build loan book performance dashboards |
